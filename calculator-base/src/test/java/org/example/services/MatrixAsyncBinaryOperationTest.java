...
class MatrixAsyncBinaryOperationTest {

    private Matrix a;
    private Matrix b;
    private DefaultAsyncMatrixExecutor matrixExecutor;
    ...
    void setUp() {
        ...
        matrixExecutor = injector.getInstance(DefaultAsyncMatrixExecutor.class);
    }
    ...
    void testEntireMatrixAddition() throws Exception {
        ...
        Future<Matrix> future = matrixExecutor.submit(a, b, BinaryType.ADD, "ADD");
    ...
    void testEntireMatrixMultiplication() throws Exception {
        ...
        Future<Matrix> future = matrixExecutor.submit(a, b, BinaryType.MULTIPLY, "MULTIPLY");
    ...
    void testEntireMatrixSubtraction() throws Exception {
        ...
        Future<Matrix> future = matrixExecutor.submit(a, b, BinaryType.SUBTRACT, "SUBTRACT");
